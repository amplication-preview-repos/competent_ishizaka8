...
@InputType()
class CategoryServiceCreateNestedManyWithoutServicesInput {
...
export { CategoryServiceCreateNestedManyWithoutServicesInput as CategoryServiceCreateNestedManyWithoutServicesInput };
