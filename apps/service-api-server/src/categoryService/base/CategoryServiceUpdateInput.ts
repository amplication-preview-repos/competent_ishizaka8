...
@InputType()
class CategoryServiceUpdateInput {
  @ApiProperty({
    required: false,
    type: String,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => ServiceUpdateManyWithoutCategoryServicesInput,
  })
  @ValidateNested()
  @Type(() => ServiceUpdateManyWithoutCategoryServicesInput)
  @IsOptional()
  @Field(() => ServiceUpdateManyWithoutCategoryServicesInput, {
    nullable: true,
  })
...
export { CategoryServiceUpdateInput as CategoryServiceUpdateInput };
