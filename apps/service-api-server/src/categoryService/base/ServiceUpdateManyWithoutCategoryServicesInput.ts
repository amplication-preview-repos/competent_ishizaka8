...
@InputType()
class ServiceUpdateManyWithoutCategoryServicesInput {
...
export { ServiceUpdateManyWithoutCategoryServicesInput as ServiceUpdateManyWithoutCategoryServicesInput };
